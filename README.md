...
<p align="center">
  ...
  <a href="manifest.json"><img src="https://img.shields.io/badge/catalog-v0.9.4-blue" alt="Catalog version 0.9.4"></a>
...
|---|---|
| `forge` | Implements the smallest bounded change and the tests that prove it. |
| `piper` | Reviews completed work for correctness, safety, scope, simplicity, and readiness. |
...
- `designing-ui-ux` — Ground personas and journeys, then design flows, states, accessibility, interface text, and recovery.
