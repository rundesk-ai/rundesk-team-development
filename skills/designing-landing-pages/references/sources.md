...
- Legal, privacy, accessibility, advertising-platform, and consent requirements change by
  ...
  sources during design and implementation; this skill supplies a design workflow, not legal advice
  or implementation authority.

## Attribution

This MIT-licensed package was transferred and renamed from `conversion-landing-pages` in
[`rundesk-team-marketing` commit `ec5c9bc3dc1fc64ae65eaf58bae4a0ca8e1e5369`](https://github.com/rundesk-ai/rundesk-team-marketing/tree/ec5c9bc3dc1fc64ae65eaf58bae4a0ca8e1e5369/skills/conversion-landing-pages).
That package was adapted from the MIT-licensed `conversion-landing-pages` package in
[`rundesk-skills` commit `826953197c01c7816fdd480e1eb91ee4fe708a8b`](https://github.com/rundesk-ai/rundesk-skills/tree/826953197c01c7816fdd480e1eb91ee4fe708a8b/skills/conversion-landing-pages).

The transfer renames the skill, assigns final page and interface design to the skill while preserving
content, brand, development, analytics, compliance, and legal boundaries, removes dependencies on
marketing-catalog siblings, and adds a catalog-native validation record. License: MIT License.
