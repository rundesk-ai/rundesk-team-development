...
Landing-page CTR, CVR, analytics events, attribution, commerce or CRM feedback, experiment metrics,
sample size, stopping rules, and low-traffic optimization need one explicit measurement contract.
...
not a causal counterfactual. Route certified mix decomposition, uncertainty, and experiment readout
to the first-party measurement owner.
